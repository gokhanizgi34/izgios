...
<main class="app">
    ...
    <nav class="tabs"><a class="{{ request('ekran','servis') === 'servis' ? 'active' : '' }}" href="?ekran=servis">Servis Geçmişi</a><a class="{{ request('ekran') === 'bakim' ? 'active' : '' }}" href="?ekran=bakim">Periyodik Bakım</a></nav>
