...
<style>
    ...
    .islem-islemleri{display:flex;align-items:center;gap:.45rem;margin-left:auto;flex-wrap:wrap}.islem-islemleri details{position:relative}.islem-islemleri summary,.islem-islemleri .islem-sil{list-style:none;border:1px solid #c8d8ee;border-radius:8px;background:#fff;color:#1764c0;padding:.42rem .62rem;font-size:.78rem;font-weight:800;white-space:nowrap;cursor:pointer}.islem-islemleri summary::-webkit-details-marker{display:none}.islem-satir:has(.islem-islemleri details[open]){flex-wrap:wrap}.islem-islemleri:has(details[open]){flex:1 0 100%;margin-left:1.85rem}.islem-islemleri details[open]{flex:1 0 100%}.islem-islemleri details form{position:static;display:grid;grid-template-columns:1fr 1fr 120px auto;gap:.55rem;width:100%;margin-top:.5rem;padding:.75rem;border:1px solid #cddbeb;border-radius:10px;background:#f8fbff;box-shadow:none}.islem-islemleri input{width:100%;padding:.55rem .65rem;border:1px solid #c9d8e9;border-radius:7px;font-size:.8rem}.islem-islemleri details button{border:0;border-radius:7px;padding:.55rem .8rem;background:#1764c0;color:#fff;font-weight:800}.islem-islemleri .islem-sil{border-color:#f3c5c9;color:#c62c3a;background:#fff6f7}.tema-koyu .islem-islemleri summary{background:#202f49;border-color:#41526e;color:#edf4ff}.tema-koyu .islem-islemleri details form{background:#17233a;border-color:#41526e}.tema-koyu .islem-islemleri input{background:#202f49;border-color:#41526e;color:#edf4ff}.tema-koyu .servis-aksiyonlar,.tema-koyu .servis-detay .card{background:#17233a;border-color:#31415b}.tema-koyu .section-title h2,.tema-koyu .bilgi-grid strong,.tema-koyu .maliyet-satir strong,.tema-koyu .islem-satir strong{color:#edf4ff}.tema-koyu .bilgi-grid>div,.tema-koyu .bos-durum{background:#202f49}.tema-koyu .servis-notu p,.tema-koyu .maliyet-satir,.tema-koyu .islem-satir p{color:#b7c5dc}.tema-koyu .servis-notu,.tema-koyu .maliyet-satir,.tema-koyu .islem-satir{border-color:#31415b}
    @media(max-width:640px){.servis-detay-hero{align-items:flex-start;flex-direction:column;padding:1.3rem}.servis-aksiyonlar .btn{width:100%;text-align:left}.islem-satir{flex-wrap:wrap}.islem-islemleri,.islem-islemleri:has(details[open]){width:100%;margin-left:0}.islem-islemleri details form{grid-template-columns:1fr;width:100%}}
