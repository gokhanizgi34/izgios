...
<style>
    ...
    .appointment-actions{display:flex;gap:6px}.appointment-actions details{position:relative}.appointment-actions summary,.appointment-actions button{list-style:none;border:1px solid #cbd9ea;border-radius:8px;background:#fff;color:#185fae;padding:7px 9px;font-size:.75rem;font-weight:800;cursor:pointer}.appointment-actions summary::-webkit-details-marker{display:none}.appointment-actions>form button{border-color:#f0c6ca;color:#bf2f3c;background:#fff7f8}.appointment-edit{position:absolute;right:0;top:calc(100% + 7px);z-index:10;display:grid;gap:7px;width:300px;padding:12px;border:1px solid #cfdaea;border-radius:12px;background:#fff;box-shadow:0 16px 35px rgba(15,42,81,.2)}.appointment-edit label{font-size:.72rem;font-weight:800;color:#385675}.appointment-edit input,.appointment-edit select,.appointment-edit textarea{width:100%;padding:7px;border:1px solid #cbd9e9;border-radius:7px}.appointment-edit button{background:#185fae;color:#fff}
    @media (max-width: 990px) { .op-grid { grid-template-columns: 1fr; } }
    @media (max-width: 650px) { .op-hero { padding: 22px 19px; border-radius: 18px; } .op-card-body { padding: 16px; } .appointment-row { grid-template-columns: 72px 1fr; gap: 12px; } .appointment-service { grid-column: 2; } .appointment-status { grid-column: 2; justify-self: start; }.appointment-actions{grid-column:2}.appointment-edit{right:auto;left:0;width:min(300px,calc(100vw - 100px))} }
