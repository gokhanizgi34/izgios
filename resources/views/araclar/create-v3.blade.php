...
@section('content')
<main class="container py-4"><x-servis-yeni-tasarim :adim="2" baslik="Araç kartı oluştur" aciklama="Araç sahibini seçin, bilgileri girin ve fiziksel QR etiketini kamerayla okutun." />
...
<x-arac-qr-okuyucu alan-id="yeniAracQr" :zorunlu="true" />
