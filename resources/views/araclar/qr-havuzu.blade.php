        ...
        <div class="table-responsive mt-4">
            <table class="table align-middle">
                ...
                @forelse($partiler as $parti)
                    <tr @class(['table-success' => request('parti') === $parti->parti_kodu])>
                        ...
                        <td><a class="btn btn-sm {{ request('parti') === $parti->parti_kodu ? 'btn-primary' : 'btn-outline-primary' }}" href="{{ route('arac-qr-havuzu.yazdir', $parti->parti_kodu) }}"><i class="bi bi-printer"></i> Aç / PDF Kaydet</a></td>
                    </tr>
                @empty
