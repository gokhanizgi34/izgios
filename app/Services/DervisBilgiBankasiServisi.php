...
class DervisBilgiBankasiServisi
{
    ...
    public function sss(): array
    {
        return [
            ...
            ['id'=>'merkezi-yapay-zeka','soru'=>'Yapay zekâ API bağlantısı nasıl çalışır?','yanit'=>'Yalnız Sistem Yöneticisi, API ve İletişim Entegrasyonları ekranındaki Merkezi Yapay Zekâ bölümünden OpenAI veya Google Gemini sağlayıcısını seçip tek API anahtarı girer. Bu anahtar bütün firmalardaki asistan, hata analizi, plaka ve fiş okuma işlemlerinde ortak kullanılır; firmalara ayrı anahtar tanımlanmaz.','anahtarlar'=>['yapay zeka api','openai anahtar','gemini anahtar','merkezi yapay zeka']],
